#--------- Flask settings
SERVER_HOST = 'https://neighborlyapp101.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 8000
...
API_URL = "https://project2connectfunction.azurewebsites.net/api/"
